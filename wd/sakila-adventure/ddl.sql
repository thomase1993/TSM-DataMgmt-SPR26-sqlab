...
ALTER TABLE actor          ADD COLUMN hash BIGINT;
ALTER TABLE address        ADD COLUMN hash BIGINT;
ALTER TABLE category       ADD COLUMN hash BIGINT;
ALTER TABLE city           ADD COLUMN hash BIGINT;
ALTER TABLE country        ADD COLUMN hash BIGINT;
ALTER TABLE customer       ADD COLUMN hash BIGINT;
ALTER TABLE film           ADD COLUMN hash BIGINT;
ALTER TABLE film_actor     ADD COLUMN hash BIGINT;
ALTER TABLE film_category  ADD COLUMN hash BIGINT;
ALTER TABLE inventory      ADD COLUMN hash BIGINT;
ALTER TABLE language       ADD COLUMN hash BIGINT;
ALTER TABLE payment        ADD COLUMN hash BIGINT;
ALTER TABLE rental         ADD COLUMN hash BIGINT;
ALTER TABLE staff          ADD COLUMN hash BIGINT;
ALTER TABLE store          ADD COLUMN hash BIGINT;
